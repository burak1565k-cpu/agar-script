...
(function (_0x1154df, _0x5c642d) {
  ...
  function _0x2c91e6() {
    ...
    document.getElementById("chat_textbox").onblur = function () { _0x404848 = false; };
    document.getElementById("chat_textbox").onfocus = function () { _0x404848 = true; };
      ...
      switch (_0x1f4f29.keyCode) {
        ...
        case 51:
          if (!_0x404848) {
            ...
            if (document.getElementById("noNames")) document.getElementById("noNames").checked = window._0x23ab14;
            _0x105918(window._0x23ab14 ? "ISIMLER GIZLENDI" : "ISIMLER ACILDI", "info");
          }
          break;
        case 67:
          if (!_0x404848) _0x512281("psx2psx2");
          break;
        case 27:
          _0x4620f0("fast");
          _0x1154df.isSpectating = false;
        ...
        case 13:
          if (_0x404848) {
            ...
            if (_0x470893.length > 0) _0x512281(_0x470893);
    ...
    _0x1154df.onkeyup = function (_0x4c2933) {
      switch (_0x4c2933.keyCode) {
        case 32: _0x57307f = false; break;
        case 87: _0x501f6d = false; break;
      }
    };

    _0x1154df.onblur = function () { _0x501f6d = _0x57307f = false; };
  ...
  function showGameAlert(text, type = "error") {
    ...
    alertEl.style.textShadow = `0 0 20px ${colors[type] || colors.error}, 0 0 40px black`;
  ...
  function updateSpatialIndex() {
    ...
    for (const cell of _0x3e0cc8) {
      if (cell.shouldRender() && !cell.prepareData && cell.size * _0x1402f0 > 20) {
  ...
  function _0xdd7d12(_0x597c71) {
    ...
    if (_0x2f3a97.length < 2) _0x2f3a97 = "0" + _0x2f3a97;
  ...
  function _0xde92b2(_0x1ec878) {
    if (_0x41adc2) {
      ...
      try { _0x41adc2.close(); } catch (_0xd99386) {}
      _0x41adc2 = null;
    }
  ...
  function _0x4508d4() {
    ...
    grecaptcha.ready(function () {
      grecaptcha.execute("6LcnrKQUAAAAADohV5Cksikz89WSP-ZPHNA7ViZm", { action: "play_game" }).then(function (_0x24fd90) {
        _0x1d7f75(_0x24fd90);
      });
    });
  }
  ...
  function _0x486d06(_0x1956d7) {
    ...
    var _0x3b5561 = 0;
    if (_0x1956d7.getUint8(_0x3b5561) == 240) _0x3b5561 += 5;

    switch (_0x1956d7.getUint8(_0x3b5561++)) {
      case 16: _0xa513e8(_0x1956d7, _0x3b5561); break;
      case 17:
        _0x1b6830 = _0x1956d7.getFloat32(_0x3b5561, true); _0x3b5561 += 4;
        _0x552165 = _0x1956d7.getFloat32(_0x3b5561, true); _0x3b5561 += 4;
        _0x503f66 = _0x1956d7.getFloat32(_0x3b5561, true); _0x3b5561 += 4;
        break;
      case 20: _0x1cf585 = []; _0x1cc1c3 = []; break;
      case 32: _0x1cc1c3.push(_0x1956d7.getUint32(_0x3b5561, true)); break;
      case 64:
        _0x22b0f0 = _0x1956d7.getFloat64(_0x3b5561, true); _0x3b5561 += 8;
        _0x12d6c2 = _0x1956d7.getFloat64(_0x3b5561, true); _0x3b5561 += 8;
        _0x55af78 = _0x1956d7.getFloat64(_0x3b5561, true); _0x3b5561 += 8;
        _0x13322c = _0x1956d7.getFloat64(_0x3b5561, true); _0x3b5561 += 8;
        break;
    }
  }
  ...
  function updateWorldNodes(view, offset) {
    ...
    while (true) {
      ...
      const nx = view.getInt16(offset, true); offset += 2;
      const ny = view.getInt16(offset, true); offset += 2;
  ...
  function _0x44fc5b() {
    if (_0x1cf585.length != 0) {
      ...
      for (var i = 0; i < _0x1cf585.length; i++) {
        totalSize += _0x1cf585[i].size;
      }
      var targetZoom = Math.pow(Math.min(64 / totalSize, 1), 0.4) * _0x951755();
      _0x1402f0 = (_0x1402f0 * 19 + targetZoom) / 20;
    }
  }

  setInterval(function () {
    if (typeof _0x44d2ff !== "undefined" && (window._0x1cf585.length > 0 || window.isSpectating)) {
      var enemies = [];
      var myPieces = [];
      var tempEnemies = [];
      ...
      for (var id in _0x44d2ff) {
        ...
        if (window._0x1cf585.indexOf(node) !== -1) {
          ...
          enemies.push({ id: node.id, x: node.x, y: node.y, s: node.size, c: node.color, v: true });
        }
      }
  ...
  function _0x5cf431() {
    ...
    var gradient = _0x16b27b.createRadialGradient(_0x35ab87 / 2, _0x84b5f1 / 2, 0, _0x35ab87 / 2, _0x84b5f1 / 2, _0x35ab87);
    gradient.addColorStop(0, "#080808");
    gradient.addColorStop(1, "#000000");
    _0x16b27b.fillStyle = gradient;
    _0x16b27b.fillRect(0, 0, _0x35ab87, _0x84b5f1);

    _0x3e0cc8.sort((a, b) => a.size == b.size ? a.id - b.id : a.size - b.size);
    ...
    // Tamamlanan ve düzeltilen Chat / Mesaj Render Döngüsü
    if (_0x2653d4 == false && typeof _0x48203d !== "undefined") {
      var _0x1865c9 = 0;
      for (var _0x42d0b2 = _0x48203d.length - 1; _0x42d0b2 >= 0; _0x42d0b2--) {
        _0x1865c9++;
        if (_0x1865c9 > 15) break;
        
        var chatItem = _0x48203d[_0x42d0b2];
        var _0xc6a056 = chatItem.name ? chatItem.name.trim() : "Agar.io";
        var _0x1612c2 = chatItem.message ? chatItem.message.trim() : "";
        var _0x3a44c9 = " : " + _0x1612c2;

        _0x16b27b.font = "18px Arial";
        chatItem.name_x = 15;
        chatItem.name_y = _0x84b5f1 - 30 - _0x1865c9 * 20;

        _0x16b27b.fillStyle = chatItem.color || "#FFFFFF";
        _0x16b27b.fillText(_0xc6a056, 15, chatItem.name_y);
        
        _0x16b27b.fillStyle = "#FFFFFF";
        _0x16b27b.fillText(_0x3a44c9, 15 + _0x16b27b.measureText(_0xc6a056).width, chatItem.name_y);
      }
    }
  }
